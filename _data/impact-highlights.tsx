...
export const ImpactHighlightsData: ImpactHighlight[] = [
  {
    id: "reach",
    title: "Reach",
    description: "Engaged 2,000+ individuals across communities in Alberta, British Columbia, Saskatchewan, and Manitoba through entrepreneurship, networking, and cultural integration initiatives.",
    icon: "Users"
  },
  {
...
export const ImpactHighlightsSection = {
  heading: "Impact Highlights",
  subheading: "Demonstrating measurable impact across communities, leadership roles, and program development initiatives.",
};
